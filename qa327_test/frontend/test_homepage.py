...
test_tickets = [
	Ticket(ticket_name='test_ticket_yo', price=10, quantity=10, expiration='2020/12/31', owners_email='test_frontend@test.com'),
	Ticket(ticket_name='test_ticket_yo', price=10, quantity=10, expiration='2020/12/31', owners_email='test_frontend@test.com'),
	Ticket(ticket_name='old_ticket_yo', price=10, quantity=10, expiration='1897/12/31', owners_email='test_frontend@test.com')
]
